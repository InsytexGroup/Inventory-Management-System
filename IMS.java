...
public class IMS {
    public static void main(String[] args) throws Exception {
        ...
        while (true) {
            ...
            if (command.equals("searchprice")) {
                ...
                saveUndoToFile(inventory, phoneFile, laptopFile, pcFile);
    ...
    private static void saveUndoToFile(CustomLinkedList inventory, File phoneFile, File laptopFile, File pcFile) {
        try {
